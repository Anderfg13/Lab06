...
public class ExportData01Test {

    @Test
    public void shouldExportDataToValidFile() {
        City city = new City();
        File file = new File("validCityExport01.txt");

        // Exportar la ciudad a un archivo válido
        assertDoesNotThrow(() -> city.exportData01(file));
    ...
    public void shouldNotExportDataToInvalidPath() {
        City city = new City();
        File file = new File("/invalidPath/exportCity01.txt"); // Ruta inválida

        // Intentar exportar a una ruta inválida
        Exception exception = assertThrows(CityException.class, () -> city.exportData01(file));
    ...
    public void shouldNotExportDataToFileWithoutPermissions() {
        City city = new City();
        File file = new File("C:/restrictedCityExport01.txt"); // Ruta sin permisos de escritura (en sistemas protegidos)
    ...
    public void shouldOverwriteExistingFile() {
        City city = new City();
        File file = new File("existingCityExport01.txt");
    ...
    public void shouldExportLargeCity() {
        ...
        File file = new File("largeCityExport01.txt");
