...
public class Open01Test {
    ...
    @Test
    public void shouldNotOpenFileWithInvalidExtension() {
    ...
    @Test
    public void shouldNotOpenNonExistentFile() {
    ...
    @Test
    public void shouldNotOpenCorruptedFile() {
    ...
    @Test
    public void shouldNotOpenEmptyFile() {
    ...
    @Test
    public void shouldOpenFileWithLargeCity() {
        City city = new City();
